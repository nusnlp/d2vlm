...
def build_model(model_path, device='cpu', dtype=torch.float16, arch_module='etchat_arch', **kwargs):
    ...
    config = AutoConfig.from_pretrained(model_path, arch_module=arch_module)
