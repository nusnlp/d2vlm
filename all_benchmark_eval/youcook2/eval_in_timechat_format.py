...
#     pass
os.chdir('all_benchmark_eval/youcook2')
...
#     parser.add_argument('--pred_file', type=str, default="/storage/wenzheng/model_zoo/timechat/original/dvc/fmt_youcook_val_f96_result.json")
    parser.add_argument('--pred_file', type=str, default="/users/wenzheng/code/projects/TRACE/eval_results/dvc_trace_embed_128/refmt_youcook_val_f128_result.json")     
#     parser.add_argument('--pred_file', type=str, default="/storage/wenzheng/model_zoo/timechat/original/vhd/fmt_qvhighlights_val_f96_result.json")

    parser.add_argument('--gt_file', type=str, default="/storage/wenzheng/dataset/TimeChat/TimeIT/data/dense_video_captioning/youcook2/val.caption_coco_format.json")
    ...
    if args.analyze:
        ...
        for k, v in results.items():
            if k == 'key':
                ...
                good_cases.append(f'{k}: {round(sum(v) / len(v), 1)}')
            else:
                good_cases.append(f'{k}: {round(sum(v) / len(v) * 100, 1)}')       
